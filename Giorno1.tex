...
Posso contare per sempre. Dato un numero, posso sempre scrivere il successivo.
...
Loro avevano (a seconda del secolo) fino a un simbolo per 1000
(poi aggiungevano barre sopra per iterare la cosa ma senza cambiare il fatto 
che arrivavano a un certo numero e poi si dovevano fermare).

Noi abbiamo lo zero e la notazione posizionale e la lingua (a parte i numeri tre 11 e 20)
