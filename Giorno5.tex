...
Dati 2 insiemi $A$ e $B$ definiamo l'unione, scriviamo $A \union B$ che è l'insieme 
...
Dati 2 insiemi $A$ e $B$ definiamo l'intersezione, scriviamo $A \inter B$ che è l'insieme 
...
Se ogni elemento di A è anche elemento di B allora A è un sottoinsieme di B e scriviamo $A \subset B$.
...
\Note{sui libri lo trovi anche definito quanto $A$ non è sottoinsieme ma a ma piace di più così al momento.
...
Dato un insieme $A$, $P(A)$ è l'insieme di tutti i sui sottoinsiemi, si chiama l'insieme delle parti.
Se $A = \{0, 1, 2\}$ allora 
$$
